        ...
        <div className="flex items-center gap-2">
          ...
          {showCommit ? (
            <div className="flex items-center gap-2">
              ...
              />
              <Button size="sm" variant="default" className="h-7 text-xs" onClick={handleCommit}>Commit</Button>
              <Button size="sm" variant="ghost" className="h-7 text-xs" onClick={() => setShowCommit(false)}>Cancel</Button>
            </div>
          ) : (
            <Button
              size="sm"
            ...
            >
              ...
              {dirtyFiles > 0 && <span className="absolute top-1 right-1 h-2 w-2 rounded-full bg-primary" />}
            </Button>
          )}
